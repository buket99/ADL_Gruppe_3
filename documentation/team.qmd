...
+-------------+------------------------------------------------+-------------------------------------+
| WP9         | Web Scraping for Image Data        | Nico Bayer                          |
+-------------+------------------------------------------------+-------------------------------------+
...
-   **KW 42-46:**
    ...
    -   Nico Bayer began development of the Image Classifier (WP1), including initial evaluation and did web scraping for image data (WP9).
...
-   **Nico Bayer:**
    ...
    -   Did web scraping for additional bottle images (WP9).
